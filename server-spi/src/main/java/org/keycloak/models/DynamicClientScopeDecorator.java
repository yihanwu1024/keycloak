...
public class DynamicClientScopeDecorator implements ClientScopeModel {

    private final ClientScopeModel delegate;
    private final String fullName;

    public DynamicClientScopeDecorator(ClientScopeModel delegate, String fullName) {
    ...
    public boolean isIncludeInOpenIDProviderMetadata() {
        return delegate.isIncludeInOpenIDProviderMetadata();
    }

    @Override
    public void setIncludeInOpenIDProviderMetadata(boolean includeInOpenIDProviderMetadata) {
        delegate.setIncludeInOpenIDProviderMetadata(includeInOpenIDProviderMetadata);
    }
    ...
    @Override
    public void removeProtocolMapper(ProtocolMapperModel model) {
        delegate.removeProtocolMapper(model);
    }

    @Override
    public void updateProtocolMapper(ProtocolMapperModel model) {
        delegate.updateProtocolMapper(model);
    }
